...
<div class="row">
    ...
    <div class="col-lg-10">
        <a href="{{ route('user.export') }}" class="btn btn-primary btn-rounded btn-fw" style="float: right;"><i class="fa fa-plus"></i> Export User</a>
    </div>
</div>
<div class="row" style="margin-top: 20px;">
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            ...
            <div class="card-body">
                <h4 class="card-title pull-left">Data User</h4>
